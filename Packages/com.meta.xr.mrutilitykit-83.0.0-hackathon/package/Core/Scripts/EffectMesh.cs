...
namespace Meta.XR.MRUtilityKit
{
    ...
    public class EffectMesh : MonoBehaviour
    {
        ...
        /// <summary>
        /// When enabled, the generated global mesh will have barycentric coordinates enabled.
        /// </summary>
        [Tooltip("When enabled, the generated global mesh will have barycentric coordinates enabled.")]
        public bool BarycentricCoordinatesEnabled;
        ...
        [HideInInspector] internal Action OnMeshLoadedComplete;
        ...
        private void ReceiveAnchorUpdatedCallback(MRUKAnchor anchor)
        {
            ...
            if (_unTrackedRooms.Contains(anchor.Room) ||
                _unTrackedAnchors.Contains(anchor) ||
                !TrackUpdates)
            {
                return;
            }
        ...
        private void CreateGlobalMeshObject(MRUKAnchor globalMeshAnchor)
        {
            ...
            if (BarycentricCoordinatesEnabled)
            {
                trimesh = Utilities.AddBarycentricCoordinatesToMesh(trimesh);
            }
